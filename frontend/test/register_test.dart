...
void main() {
  ...
  testWidgets("Visitor name field is not empty", (WidgetTester tester) async{
    ...
    // expect(find.byElementType(), findsOneWidget);
    // expect(find.text("Hora de visita no válida."), findsOneWidget);
    expect(find.byKey(const ValueKey("qrCodeModal")), findsOneWidget);
    // expect(find.byElementType(RoundedRectangleBorder), findsOneWidget);
  });
